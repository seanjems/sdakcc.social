...
public class sdakccDbContext :
    AbpDbContext<sdakccDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public sdakccDbContext(DbContextOptions<sdakccDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(sdakccConsts.DbTablePrefix + "YourEntities", sdakccConsts.DbSchema);
